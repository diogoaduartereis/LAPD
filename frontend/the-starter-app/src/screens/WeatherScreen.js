...
class WeatherScreen extends React.Component {
  ...
  getWeather() {
    ...
    let url =
      ...
      "&units=metric&appid=0c897a3f52b79390b136a9a2e1e36921&cnt=5";
        ...
        <ScrollView>
          <View style={styles.container}>
                ...
                <Image
                  source={{
                    uri:
                      ...
                      firstElement.weather[0].icon +
                      ".png"
                  }}
                  style={{ width: 150, height: 150, left: 50 }}
                />
                <Text style={{ fontSize: 20, fontWeight: "bold", bottom: 40 }}>
                  {firstElement.main.temp} °C
                </Text>
                <Text style={{ fontSize: 15, bottom: 20 }}>
                  {firstElement.weather[0].description}
                </Text>
              </View>
            </View>
            ...
            <View
              style={[
                styles.card,
                { padding: 20, paddingVertical: 30, marginTop: 20 }
              ]}
            >
              ...
              <View style={{ alignItems: "center", alignContent: "center" }}>
                ...
                >
                  ...
                  <View style={styles.iconWeather}>
                    ...
                    <Text>
                      {firstElement.rain ? firstElement.rain["3h"] : 0} mm
                    </Text>
                  </View>
                  <View
                    style={{
              ...
              <FlatList
                data={this.state.forecast.list.slice(1)}
              ...
              <View style={{ alignItems: "center", alignContent: "center" }}>
                <Button
                  onPress={() =>
                    Linking.openURL("https://openweathermap.org/city")
                  }
